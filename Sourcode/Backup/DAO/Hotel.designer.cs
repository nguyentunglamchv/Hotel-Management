...
namespace DAO
{
	...
	[System.Data.Linq.Mapping.DatabaseAttribute(Name="qlks3lop")]
    ...
    partial void Deletehethong(hethong instance);
		...
		[Function(Name="dbo.kiemtraphong")]
		public ISingleResult<kiemtraphongResult> kiemtraphong([Parameter(DbType="DateTime")] System.Nullable<System.DateTime> ngayden, [Parameter(DbType="DateTime")] System.Nullable<System.DateTime> ngaydi)
		{
		...
		[Function(Name="dbo.InhoadonDichVu")]
		public ISingleResult<InhoadonDichVuResult> InhoadonDichVu([Parameter(DbType="VarChar(10)")] string mahoadon)
		{
		...
		[Function(Name="dbo.InhoadonPhong")]
		public ISingleResult<InhoadonPhongResult> InhoadonPhong([Parameter(DbType="VarChar(10)")] string mahoadon)
		{
			IExecuteResult result = this.ExecuteMethodCall(this, ((MethodInfo)(MethodInfo.GetCurrentMethod())), mahoadon);
    ...
    partial void OnchucvuChanged();
		...
		[Column(Storage="_manhanvien", DbType="VarChar(10) NOT NULL", CanBeNull=false, IsPrimaryKey=true)]
		...
		[Column(Storage="_tennhanvien", DbType="NVarChar(50)")]
		...
		[Column(Storage="_phai", DbType="Bit")]
		...
		[Column(Storage="_phone", DbType="VarChar(11)")]
		public string phone
		{
			get
			{
		...
		[Association(Name="nhanvien_hethong", Storage="_hethongs", ThisKey="manhanvien", OtherKey="manhanvien")]
	...
	[Table(Name="dbo.chitietdatphong")]
    ...
    partial void OnmaphongChanged();
		...
		[Column(Storage="_maphieudat", DbType="VarChar(10) NOT NULL", CanBeNull=false, IsPrimaryKey=true)]
		...
		[Column(Storage="_maphong", DbType="VarChar(10) NOT NULL", CanBeNull=false, IsPrimaryKey=true)]
		...
		[Association(Name="phong_chitietdatphong", Storage="_phong", ThisKey="maphong", OtherKey="maphong", IsForeignKey=true)]
		public phong phong
		{
			get
			{
		...
		[Association(Name="phieudatphong_chitietdatphong", Storage="_phieudatphong", ThisKey="maphieudat", OtherKey="maphieudat", IsForeignKey=true)]
    ...
    partial void OnsoluongChanged();
		...
		[Column(Storage="_mavattu", DbType="VarChar(10) NOT NULL", CanBeNull=false, IsPrimaryKey=true)]
		...
		[Column(Storage="_maloaiphong", DbType="NVarChar(50) NOT NULL", CanBeNull=false, IsPrimaryKey=true)]
		...
		[Association(Name="loaiphong_chitietvattu", Storage="_loaiphong", ThisKey="maloaiphong", OtherKey="maloai", IsForeignKey=true)]
		...
		[Association(Name="vattu_chitietvattu", Storage="_vattu", ThisKey="mavattu", OtherKey="mavattu", IsForeignKey=true)]
		public vattu vattu
		{
			get
			{
    ...
    partial void OnusernameChanged();
		...
		[Column(Storage="_mahoadon", DbType="VarChar(10) NOT NULL", CanBeNull=false, IsPrimaryKey=true)]
		...
		[Column(Storage="_ngaythanhtoan", DbType="DateTime NOT NULL")]
		...
		[Column(Storage="_tongtien", DbType="Money")]
		...
		[Column(Storage="_maphieuthue", DbType="VarChar(10)")]
		...
		[Column(Storage="_makhachhang", DbType="VarChar(10)")]
		...
		[Column(Storage="_username", DbType="VarChar(10)")]
		...
		[Association(Name="khachhang_hoadon", Storage="_khachhang", ThisKey="makhachhang", OtherKey="makhachhang", IsForeignKey=true)]
		...
		[Association(Name="phieuthuephong_hoadon", Storage="_phieuthuephong", ThisKey="maphieuthue", OtherKey="maphieuthue", IsForeignKey=true)]
		...
		[Association(Name="hethong_hoadon", Storage="_hethong", ThisKey="username", OtherKey="username", IsForeignKey=true)]
    ...
    partial void OnemailChanged();
		...
		[Column(Storage="_makhachhang", DbType="VarChar(10) NOT NULL", CanBeNull=false, IsPrimaryKey=true)]
		public string makhachhang
		{
			get
			{
		...
		[Column(Storage="_tenkhachhang", DbType="NVarChar(50)")]
		...
		[Column(Storage="_cmnd_passport", DbType="VarChar(10)")]
		...
		[Column(Storage="_coquan", DbType="NVarChar(50)")]
		...
		[Column(Storage="_sodienthoai", DbType="VarChar(11)")]
		...
		[Association(Name="khachhang_hoadon", Storage="_hoadons", ThisKey="makhachhang", OtherKey="makhachhang")]
		...
		[Association(Name="khachhang_phieudatphong", Storage="_phieudatphongs", ThisKey="makhachhang", OtherKey="makhachhang")]
    ...
    partial void OnsonguoiChanged();
		...
		[Column(Storage="_maloai", DbType="NVarChar(50) NOT NULL", CanBeNull=false, IsPrimaryKey=true)]
		...
		[Column(Storage="_songuoi", DbType="Int")]
		...
		[Association(Name="loaiphong_chitietvattu", Storage="_chitietvattus", ThisKey="maloai", OtherKey="maloaiphong")]
		...
		[Association(Name="loaiphong_phong", Storage="_phongs", ThisKey="maloai", OtherKey="maloai")]
    ...
    partial void OnusernameChanged();
		...
		[Column(Storage="_maphieuthue", DbType="VarChar(10) NOT NULL", CanBeNull=false, IsPrimaryKey=true)]
		public string maphieuthue
		{
			get
			{
		...
		[Column(Storage="_maphieudat", DbType="VarChar(10)")]
		public string maphieudat
		{
			get
			{
		...
		[Association(Name="phieuthuephong_hoadon", Storage="_hoadons", ThisKey="maphieuthue", OtherKey="maphieuthue")]
		public EntitySet<hoadon> hoadons
		{
			get
			{
		...
		[Association(Name="phieuthuephong_chitietthuephong", Storage="_chitietthuephongs", ThisKey="maphieuthue", OtherKey="maphieuthue")]
		...
		[Association(Name="phieudatphong_phieuthuephong", Storage="_phieudatphong", ThisKey="maphieudat", OtherKey="maphieudat", IsForeignKey=true)]
		public phieudatphong phieudatphong
		{
			get
			{
		...
		[Association(Name="hethong_phieuthuephong", Storage="_hethong", ThisKey="username", OtherKey="username", IsForeignKey=true)]
		public hethong hethong
		{
			get
			{
    ...
    partial void OndanhanChanged();
		...
		[Column(Storage="_maloai", DbType="NVarChar(50) NOT NULL", CanBeNull=false)]
		public string maloai
		{
			get
			{
		...
		[Column(Storage="_dadat", DbType="Bit")]
		...
		[Column(Storage="_danhan", DbType="Bit")]
		...
		[Association(Name="phong_chitietdatphong", Storage="_chitietdatphongs", ThisKey="maphong", OtherKey="maphong")]
		...
		[Association(Name="phong_trangthaiphong", Storage="_trangthaiphongs", ThisKey="maphong", OtherKey="maphong")]
		...
		[Association(Name="phong_chitietthuephong", Storage="_chitietthuephongs", ThisKey="maphong", OtherKey="maphong")]
		public EntitySet<chitietthuephong> chitietthuephongs
		{
			get
			{
		...
		[Association(Name="loaiphong_phong", Storage="_loaiphong", ThisKey="maloai", OtherKey="maloai", IsForeignKey=true)]
		public loaiphong loaiphong
		{
			get
			{
    ...
    partial void OntrangthaiChanged();
		...
		[Column(Storage="_trangthai", DbType="VarChar(10) NOT NULL", CanBeNull=false, IsPrimaryKey=true)]
		...
		[Association(Name="phong_trangthaiphong", Storage="_phong", ThisKey="maphong", OtherKey="maphong", IsForeignKey=true)]
		public phong phong
		{
			get
			{
    ...
    partial void OntenvattuChanged();
		...
		[Column(Storage="_tenvattu", DbType="NVarChar(50)")]
		...
		[Association(Name="vattu_chitietvattu", Storage="_chitietvattus", ThisKey="mavattu", OtherKey="mavattu")]
		public EntitySet<chitietvattu> chitietvattus
		{
			get
			{
	...
	[Table(Name="dbo.chitietthuephong")]
    ...
    partial void OnsoluongChanged();
		...
		[Column(Storage="_ngay", DbType="DateTime NOT NULL", IsPrimaryKey=true)]
		...
		[Column(Storage="_madichvu", DbType="VarChar(10) NOT NULL", CanBeNull=false, IsPrimaryKey=true)]
		...
		[Association(Name="phieuthuephong_chitietthuephong", Storage="_phieuthuephong", ThisKey="maphieuthue", OtherKey="maphieuthue", IsForeignKey=true)]
		public phieuthuephong phieuthuephong
		{
			get
			{
		...
		[Association(Name="phong_chitietthuephong", Storage="_phong", ThisKey="maphong", OtherKey="maphong", IsForeignKey=true)]
		public phong phong
		{
			get
			{
		...
		[Association(Name="dichvu_chitietthuephong", Storage="_dichvu", ThisKey="madichvu", OtherKey="madichvu", IsForeignKey=true)]
    ...
    partial void OndonvitinhChanged();
		...
		[Column(Storage="_tendichvu", DbType="NVarChar(50)")]
		...
		[Column(Storage="_donvitinh", DbType="NChar(10)")]
		...
		[Association(Name="dichvu_chitietthuephong", Storage="_chitietthuephongs", ThisKey="madichvu", OtherKey="madichvu")]
		public EntitySet<chitietthuephong> chitietthuephongs
		{
			get
			{
    ...
    partial void OnsonguoiChanged();
		...
		[Column(Storage="_makhachhang", DbType="VarChar(10) NOT NULL", CanBeNull=false)]
		public string makhachhang
		{
			get
			{
		...
		[Column(Storage="_ngayden", DbType="DateTime")]
		...
		[Column(Storage="_ngaydi", DbType="DateTime")]
		...
		[Column(Storage="_sotiendatcoc", DbType="Money")]
		...
		[Column(Storage="_tinhtrang", DbType="VarChar(10)")]
		...
		[Association(Name="phieudatphong_chitietdatphong", Storage="_chitietdatphongs", ThisKey="maphieudat", OtherKey="maphieudat")]
		public EntitySet<chitietdatphong> chitietdatphongs
		{
			get
			{
		...
		[Association(Name="phieudatphong_phieuthuephong", Storage="_phieuthuephongs", ThisKey="maphieudat", OtherKey="maphieudat")]
		...
		[Association(Name="khachhang_phieudatphong", Storage="_khachhang", ThisKey="makhachhang", OtherKey="makhachhang", IsForeignKey=true)]
		public khachhang khachhang
		{
			get
			{
    ...
    partial void OnpasswordChanged();
		...
		[Column(Storage="_username", DbType="VarChar(10) NOT NULL", CanBeNull=false, IsPrimaryKey=true)]
		public string username
		{
			get
			{
		...
		[Column(Storage="_manhanvien", DbType="VarChar(10)")]
		public string manhanvien
		{
			get
			{
		...
		[Association(Name="hethong_hoadon", Storage="_hoadons", ThisKey="username", OtherKey="username")]
		public EntitySet<hoadon> hoadons
		{
			get
			{
		...
		[Association(Name="hethong_phieuthuephong", Storage="_phieuthuephongs", ThisKey="username", OtherKey="username")]
		public EntitySet<phieuthuephong> phieuthuephongs
		{
			get
			{
		...
		[Association(Name="nhanvien_hethong", Storage="_nhanvien", ThisKey="manhanvien", OtherKey="manhanvien", IsForeignKey=true)]
	...
	public partial class kiemtraphongResult
	{
		...
		[Column(Storage="_maphieudat", DbType="VarChar(10) NOT NULL", CanBeNull=false)]
		public string maphieudat
		{
			get
			{
		...
		[Column(Storage="_maphong", DbType="VarChar(10) NOT NULL", CanBeNull=false)]
		public string maphong
		{
			get
			{
	...
	public partial class InhoadonDichVuResult
	{
		...
		[Column(Storage="_maphieuthue", DbType="VarChar(10) NOT NULL", CanBeNull=false)]
		public string maphieuthue
		{
			get
			{
		...
		[Column(Storage="_mahoadon", DbType="VarChar(10) NOT NULL", CanBeNull=false)]
		public string mahoadon
		{
			get
			{
	...
	public partial class InhoadonPhongResult
	{
		...
		[Column(Storage="_ngayo", DbType="Int")]
